...
const BDailyImg = () => {
  ...
  const fetchImages = () => {
    axios
      .get(`${API_BASE_URL}/biomed-daily-images`, {
        headers: {
  ...
  const handleAddImage = (e) => {
    ...
    axios
      .post(`${API_BASE_URL}/biomed-daily-images`, formData)
      .then((response) => {
  ...
  const handleUpdateImage = (e) => {
    ...
    axios
      .put(`${API_BASE_URL}/biomed-daily-images/${editImageId}`, formData)
      .then((response) => {
        console.log(response.data.message);
        setDate("");
        setFile(null);
