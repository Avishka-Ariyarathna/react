...
const BUpdateMachinePopup = () => {
  ...
  useEffect(() => {
    const fetchMachines = async () => {
      try {
        const response = await axios.get(`${API_BASE_URL}/bmachines`, {
          headers: {
  ...
  const handleUpdate = async () => {
    ...
    try {
      const response = await axios.put(`${API_BASE_URL}/bmachines`, {
...
export default BUpdateMachinePopup;
