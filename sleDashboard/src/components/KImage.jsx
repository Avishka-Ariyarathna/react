...
const KDailyImg = () => {
  ...
  const fetchImages = () => {
    axios
      .get(`${API_BASE_URL}/kumbal-daily-images`, {
        headers: {
  ...
  const handleAddImage = (e) => {
    ...
    axios
      .post(`${API_BASE_URL}/kumbal-daily-images`, formData)
      .then((response) => {
  ...
  const handleUpdateImage = (e) => {
    ...
    axios
      .put(`${API_BASE_URL}/kumbal-daily-images/${editImageId}`, formData)
      .then((response) => {
        console.log(response.data.message);
        setDate("");
        setFile(null);
