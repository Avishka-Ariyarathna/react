...
const KUpdateMachinePopup = () => {
  ...
  useEffect(() => {
    const fetchMachines = async () => {
      try {
        const response = await axios.get(`${API_BASE_URL}/kmachines`, {
          headers: {
  ...
  const handleUpdate = async () => {
    ...
    try {
      const response = await axios.put(`${API_BASE_URL}/kmachines`, {
...
export default KUpdateMachinePopup;
