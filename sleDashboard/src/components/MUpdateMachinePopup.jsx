...
const MUpdateMachinePopup = () => {
  ...
  useEffect(() => {
    const fetchMachines = async () => {
      try {
        const response = await axios.get(`${API_BASE_URL}/mempmachines`, {
          headers: {
  ...
  const handleUpdate = async () => {
    ...
    try {
      const response = await axios.put(`${API_BASE_URL}/mempmachines`, {
...
export default MUpdateMachinePopup;
